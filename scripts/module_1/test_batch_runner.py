...
if __name__ == "__main__":
    DEFAULT_INPUT = str(PROJECT_ROOT / "tests/data/unit_tests/module_1/for_demo_video/module_1_input/zalo")
    DEFAULT_OUTPUT = str(PROJECT_ROOT / "tests/data/outputs/unit_tests/module_1/for_demo_video/test_batch_zalo")
